...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices[0].position = D3DXVECTOR3(-1.0f, -1.0f, -3.0f);  // Bottom left.
	vertices[0].color = D3DXVECTOR4(1.0f, 1.0f, 0.0f, 1.0f);

	vertices[1].position = D3DXVECTOR3(-3.0f, 1.0f, 3.0f);  // Top left.
	vertices[1].color = D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f);

	vertices[2].position = D3DXVECTOR3(3.0f, -1.0f, -1.0f);  // Bottom right.
	vertices[2].color = D3DXVECTOR4(0.0f, 1.0f, 1.0f, 1.0f);

	vertices[3].position = D3DXVECTOR3(1.0f, 2.0f, 1.0f);  // Top right.
